...
def save_user(user_claims):
    ...
    if existing_user:
        ...
        existing_user.nome = f"{user_claims.get('first_name', '')} {user_claims.get('last_name', '')}".strip()
    ...
    # Senha aleatória para o usuário, já que a autenticação será via Replit
    import secrets
